"""Equipment service – FastAPI entry point (port 8005)."""
...
app = FastAPI(
    title="KisanKiAwaaz Equipment Service",
    version="2.0.0",
    lifespan=lifespan,
)
...
# ── Routes ───────────────────────────────────────────────────────
app.include_router(api_router, prefix="/api/v1/equipment")


@app.get("/health", status_code=HttpStatus.OK)
async def health():
    """Liveness probe."""
    return {"status": "healthy", "service": "equipment"}
