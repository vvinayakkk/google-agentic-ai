"""Crop service – FastAPI entry point (port 8003)."""
...
app = FastAPI(
    title="KisanKiAwaaz Crop Service",
    version="2.0.0",
    lifespan=lifespan,
)
...
# ── Routes ───────────────────────────────────────────────────────
app.include_router(api_router, prefix="/api/v1/crops")


@app.get("/health", status_code=HttpStatus.OK)
async def health():
    """Liveness probe."""
    return {"status": "healthy", "service": "crop"}
