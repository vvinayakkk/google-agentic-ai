    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={styles.headerSmall}> {/* Reduced header size */}
          ...
          <View style={styles.userInfoCard}>
            <View style={styles.userInfoTop}>
              <Image
                source={{ uri: 'https://placehold.co/100x100/EFEFEF/333?text=M' }}
                style={styles.profileImage}
              />
              <View style={styles.userInfoTextContainer}>
                <Text style={styles.userName}>Mohamed...</Text>
                <Text style={styles.userEmail}>me354172@gmai.com</Text>
              </View>
          ...
          <Section title="Purchase Coins">
             <ProfileRow icon={<FontAwesome5 name="money-bill-wave" size={20} color={theme.darkGreen} />} text="Buy Now" />
          </Section>

          <Section title="Security & Language">
            <ProfileRow icon={<Feather name="lock" size={24} color={theme.darkGreen} />} text="Change Password" />
            <View style={styles.divider} />
            <ProfileRow icon={<FontAwesome name="language" size={24} color={theme.darkGreen} />} text="Language" />
          </Section>
          ...
          <Section title="Preferences">
             ...
             <View style={styles.divider} />
             <ProfileRow icon={<MaterialCommunityIcons name="scale-balance" size={24} color={theme.darkGreen} />} text="Our Polices" />
          </Section>

          <Section title="Account Management">
             <ProfileRow icon={<AntDesign name="delete" size={24} color={theme.red} />} text="Delete Account" isDestructive />
             <View style={styles.divider} />
             <ProfileRow icon={<AntDesign name="logout" size={24} color={theme.red} />} text="Logout" isDestructive />
          </Section>
