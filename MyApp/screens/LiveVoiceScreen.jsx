...
export default function LiveVoiceScreen({ navigation }) {
  ...
  const testNetworkConnection = async () => {
    try {
      ...
      console.log(`Testing connection to: http://192.168.0.109:8001`);
      ...
      const response = await axios.post(`http://192.168.0.109:8001/agent`, testPayload, {
        timeout: 5000,
  ...
  const processVoiceCommand = async (audioUri) => {
    ...
    try {
      ...
      console.log(`Making request to: http://192.168.0.109:8001/audio_agent`);
