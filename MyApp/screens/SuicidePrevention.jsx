...
            <MaterialCommunityIcons name={item.icon} size={24} color={theme.colors.onPrimary || '#fff'} />
          </View>
...
            onPress={() => handleCall(item.number, name)}
          >
            <Ionicons name="call" size={20} color={theme.colors.onPrimary || '#fff'} />
          </TouchableOpacity>
        </View>
...
          >
            <Ionicons name="call" size={20} color={theme.colors.onPrimary || '#000'} />
          </TouchableOpacity>
        </View>
